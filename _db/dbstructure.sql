...
INSERT INTO `adminpanel` VALUES (10,'规则管理','modrules.php','编辑/添加/删除规则页'),(8,'FreeLeech','freeleech.php','设置所有任务，在特殊的国家'),(9,'FAQ管理','faqmanage.php','编辑/添加/删除FAQ页'),(7,'警告用户','warned.php','查看所有警告用户跟踪'),(6,'投票概述','polloverview.php','查看投票方式进行表决'),(4,'群发消息','staffmess.php','发短消息给所有用户'),(3,'重设用户密码','reset.php','修改丢失的密码'),(1,'添加用户','adduser.php','创建新用户帐户'),(11,'分类管理','catmanage.php','在您的网站，管理分类类别');
...
INSERT INTO `avps` VALUES ('lastcleantime','',0,1274104801),('last24','',947,1211708476),('lastcleantime2','',0,1274103601),('lastcleantime3','',0,1274101801),('lastcleantime4','',0,1274079901),('lastcleantime5','',0,1273652875);
...
INSERT INTO `modpanel` VALUES (6,'统计资料','stats.php','跟踪统计'),(4,'广告管理','admanage.php','在您的网站管理广告'),(5,'上传者','uploaders.php','上传者统计'),(3,'所有客户端（目前）','allagents.php','所有客户端（下载/上传/种子）'),(2,'重复IP检查','ipcheck.php','检查重复的IP用户'),(1,'上传速度异常探测器','cheaters.php','查看作弊者'),(7,'IP测试','testip.php','测试，如果IP被禁止'),(8,'积分','amountbonus.php','添加一个或所有用户的积分'),(9,'清除缓存','clearcache.php','清除memcached的缓存');
...
INSERT INTO `sysoppanel` VALUES (8,'到位桶','bitbucketlog.php','到位桶登录'),(7,'登录失败','maxlogin.php','显示失败的登录尝试'),(6,'禁止系统','bans.php','禁止/取消禁止IP'),(5,'做清理','docleanup.php','做清理功能'),(4,'群发邮件','massmail.php','发送电​​子邮件给所有用户'),(3,'MySQL的统计资料','mysql_stats.php','查看MySQL统计'),(2,'管理论坛','forummanage.php','编辑/删除论坛'),(1,'删除被禁用的用户','deletedisabled.php','删除所有被禁用的用户'),(9,'班EMAIL地址','bannedemails.php','禁止电子邮件停止登记'),(10,'允许电子邮件地址','allowedemails.php','允许注册邮件'),(11,'位置','location.php','管理位置和定位速度'),(12,'添加上传','amountupload.php','添加上传到某些类');
...
-- Dump completed on 2013-01-10 16:46:24
